...
@TestPropertySource(properties = {
        "inspectit.exporters.tracing.open-census-agent.enabled=true",
...
public class OpenCensusAgentTraceExporterServiceIntTest extends SpringTestBase {
    ...
    public void testGrpcRequest() {
        ...
        assert( 2 == fakeOcAgentTraceServiceGrpc.getExportTraceServiceRequests().size());
        assertEquals(SPAN_NAME, fakeOcAgentTraceServiceGrpc.getExportTraceServiceRequests().get(1).getSpansList().get(0).getName().getValue());
    }
