...
public class IPUtils {
    ...
    private static final Pattern IP_PATTERN = Pattern.compile(
            "^(([01]?\\d\\d?|2[0-4]\\d|25[0-5])\\.){3}([01]?\\d\\d?|2[0-4]\\d|25[0-5])($|(\\/[1-9]$|\\/[1-2][0-9]$|\\/3[0-2]$))");
    ...
    /**
     * Returns true, if the given String is an IP or a CIDR.
     * @return
     */
    public boolean isIpAdresse(String ip){
