...
@SpringBootTest(
        ...
        properties = {
                "inspectit-eum-server.exporters.tracing.jaeger.grpc=localhost:14250",
...
public class JaegerExporterIntTest {
    ...
    public static final String JAEGER_URL = "http://localhost";

    @Container
    public static GenericContainer<?> jaegerContainer =
            new FixedHostPortGenericContainer<>("ghcr.io/open-telemetry/java-test-containers:jaeger")
                    .withFixedExposedPort(COLLECTOR_PORT, COLLECTOR_PORT)
                    .withExposedPorts(QUERY_PORT, HEALTH_PORT)
    ...
    private String getSpanString() {
        String now = System.currentTimeMillis() + "000000";
