  ...
  render() {
    ...
    return(
      <div className='this'>
        ...
        `}</style>
        <TabMenu className='myClass' model={this.state.navItems} activeItem={this.state.activeItem} onTabChange={(e) => {this.setState({activeItem: e.value}); this.props.router.push(e.value.href) }} />
      </div>
    )  
  }
}
